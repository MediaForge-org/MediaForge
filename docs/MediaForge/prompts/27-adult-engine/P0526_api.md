# P0526 — Stash-derived adult engine integration and fork boundary: api

**Track:** 27-adult-engine  
**Priority:** P2  
**Prompt position in track:** 6/20  
**Depends on:** P0525, P0140, P0120
...
1. Inspect the existing implementation specifically for **Stash-derived adult engine integration and fork boundary** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0526**
