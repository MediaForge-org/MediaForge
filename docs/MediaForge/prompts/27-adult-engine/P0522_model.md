# P0522 — Stash-derived adult engine integration and fork boundary: model

**Track:** 27-adult-engine  
**Priority:** P2  
**Prompt position in track:** 2/20  
**Depends on:** P0521, P0140, P0120
...
1. Inspect the existing implementation specifically for **Stash-derived adult engine integration and fork boundary** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0522**
