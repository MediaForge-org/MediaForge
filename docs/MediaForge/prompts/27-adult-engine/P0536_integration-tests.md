# P0536 — Stash-derived adult engine integration and fork boundary: integration-tests

**Track:** 27-adult-engine  
**Priority:** P2  
**Prompt position in track:** 16/20  
**Depends on:** P0535, P0140, P0120
...
1. Inspect the existing implementation specifically for **Stash-derived adult engine integration and fork boundary** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0536**
