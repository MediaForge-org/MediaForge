# P0535 — Stash-derived adult engine integration and fork boundary: unit-tests

**Track:** 27-adult-engine  
**Priority:** P2  
**Prompt position in track:** 15/20  
**Depends on:** P0534, P0140, P0120
...
1. Inspect the existing implementation specifically for **Stash-derived adult engine integration and fork boundary** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0535**
