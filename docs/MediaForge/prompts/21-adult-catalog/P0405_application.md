# P0405 — Adult scene/performer/studio catalog, sources and coverage: application
...
1. Inspect the existing implementation specifically for **Adult scene/performer/studio catalog, sources and coverage** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0405**
