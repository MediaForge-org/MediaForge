# P0417 — Adult scene/performer/studio catalog, sources and coverage: e2e-tests
...
1. Inspect the existing implementation specifically for **Adult scene/performer/studio catalog, sources and coverage** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0417**
