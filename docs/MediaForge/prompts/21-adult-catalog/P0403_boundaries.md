# P0403 — Adult scene/performer/studio catalog, sources and coverage: boundaries
...
1. Inspect the existing implementation specifically for **Adult scene/performer/studio catalog, sources and coverage** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0403**
