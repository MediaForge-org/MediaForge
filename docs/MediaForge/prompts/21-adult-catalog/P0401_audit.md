# P0401 — Adult scene/performer/studio catalog, sources and coverage: audit
...
1. Inspect the existing implementation specifically for **Adult scene/performer/studio catalog, sources and coverage** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0401**
