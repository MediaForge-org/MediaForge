# P0410 — Adult scene/performer/studio catalog, sources and coverage: jobs
...
1. Inspect the existing implementation specifically for **Adult scene/performer/studio catalog, sources and coverage** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0410**
