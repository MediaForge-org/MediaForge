# P0407 — Adult scene/performer/studio catalog, sources and coverage: frontend
...
1. Inspect the existing implementation specifically for **Adult scene/performer/studio catalog, sources and coverage** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0407**
