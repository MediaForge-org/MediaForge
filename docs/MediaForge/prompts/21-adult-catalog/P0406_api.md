# P0406 — Adult scene/performer/studio catalog, sources and coverage: api
...
1. Inspect the existing implementation specifically for **Adult scene/performer/studio catalog, sources and coverage** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0406**
