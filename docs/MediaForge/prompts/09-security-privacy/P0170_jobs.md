# P0170 — Authentication, authorization, security and privacy foundation: jobs
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0170**
