# P0171 — Authentication, authorization, security and privacy foundation: realtime
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0171**
