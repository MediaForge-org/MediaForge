# P0177 — Authentication, authorization, security and privacy foundation: e2e-tests
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0177**
