# P0169 — Authentication, authorization, security and privacy foundation: security
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0169**
