# P0166 — Authentication, authorization, security and privacy foundation: api
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0166**
