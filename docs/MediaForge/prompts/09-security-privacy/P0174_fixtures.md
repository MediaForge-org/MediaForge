# P0174 — Authentication, authorization, security and privacy foundation: fixtures
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0174**
