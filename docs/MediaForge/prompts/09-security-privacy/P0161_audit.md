# P0161 — Authentication, authorization, security and privacy foundation: audit
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0161**
