# P0165 — Authentication, authorization, security and privacy foundation: application
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0165**
