# P0176 — Authentication, authorization, security and privacy foundation: integration-tests
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0176**
