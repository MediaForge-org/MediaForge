# P0175 — Authentication, authorization, security and privacy foundation: unit-tests
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0175**
