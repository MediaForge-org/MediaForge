# P0167 — Authentication, authorization, security and privacy foundation: frontend
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0167**
