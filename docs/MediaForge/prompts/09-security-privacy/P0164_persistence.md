# P0164 — Authentication, authorization, security and privacy foundation: persistence
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0164**
