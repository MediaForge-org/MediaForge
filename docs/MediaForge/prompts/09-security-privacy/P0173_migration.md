# P0173 — Authentication, authorization, security and privacy foundation: migration
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **migration**.
...
- **Tests run + results**
- **Behavior guaranteed after P0173**
