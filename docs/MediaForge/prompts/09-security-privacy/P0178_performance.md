# P0178 — Authentication, authorization, security and privacy foundation: performance
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0178**
