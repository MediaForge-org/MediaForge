# P0179 — Authentication, authorization, security and privacy foundation: docs
...
1. Inspect the existing implementation specifically for **Authentication, authorization, security and privacy foundation** and the current focus **docs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0179**
