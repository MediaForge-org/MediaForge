# P0504 — Jellyfin-derived video engine integration and fork boundary: persistence

**Track:** 26-video-engine  
**Priority:** P2  
**Prompt position in track:** 4/20  
**Depends on:** P0503, P0140, P0120
...
1. Inspect the existing implementation specifically for **Jellyfin-derived video engine integration and fork boundary** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0504**
