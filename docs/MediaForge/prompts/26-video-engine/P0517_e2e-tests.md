# P0517 — Jellyfin-derived video engine integration and fork boundary: e2e-tests

**Track:** 26-video-engine  
**Priority:** P2  
**Prompt position in track:** 17/20  
**Depends on:** P0516, P0140, P0120
...
1. Inspect the existing implementation specifically for **Jellyfin-derived video engine integration and fork boundary** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0517**
