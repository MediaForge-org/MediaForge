# P0514 — Jellyfin-derived video engine integration and fork boundary: fixtures

**Track:** 26-video-engine  
**Priority:** P2  
**Prompt position in track:** 14/20  
**Depends on:** P0513, P0140, P0120
...
1. Inspect the existing implementation specifically for **Jellyfin-derived video engine integration and fork boundary** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0514**
