# P0516 — Jellyfin-derived video engine integration and fork boundary: integration-tests

**Track:** 26-video-engine  
**Priority:** P2  
**Prompt position in track:** 16/20  
**Depends on:** P0515, P0140, P0120
...
1. Inspect the existing implementation specifically for **Jellyfin-derived video engine integration and fork boundary** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0516**
