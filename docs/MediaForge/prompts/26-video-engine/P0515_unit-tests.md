# P0515 — Jellyfin-derived video engine integration and fork boundary: unit-tests

**Track:** 26-video-engine  
**Priority:** P2  
**Prompt position in track:** 15/20  
**Depends on:** P0514, P0140, P0120
...
1. Inspect the existing implementation specifically for **Jellyfin-derived video engine integration and fork boundary** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0515**
