# P0601 — Music, podcasts and general audio media support: audit
...
1. Inspect the existing implementation specifically for **Music, podcasts and general audio media support** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0601**
