# P0611 — Music, podcasts and general audio media support: realtime
...
1. Inspect the existing implementation specifically for **Music, podcasts and general audio media support** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0611**
