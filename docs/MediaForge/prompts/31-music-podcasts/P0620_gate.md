# P0620 — Music, podcasts and general audio media support: gate
...
1. Inspect the existing implementation specifically for **Music, podcasts and general audio media support** and the current focus **gate**.
...
- **Tests run + results**
- **Behavior guaranteed after P0620**
