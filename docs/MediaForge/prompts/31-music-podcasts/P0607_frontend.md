# P0607 — Music, podcasts and general audio media support: frontend
...
1. Inspect the existing implementation specifically for **Music, podcasts and general audio media support** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0607**
