# P0610 — Music, podcasts and general audio media support: jobs
...
1. Inspect the existing implementation specifically for **Music, podcasts and general audio media support** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0610**
