# P0604 — Music, podcasts and general audio media support: persistence
...
1. Inspect the existing implementation specifically for **Music, podcasts and general audio media support** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0604**
