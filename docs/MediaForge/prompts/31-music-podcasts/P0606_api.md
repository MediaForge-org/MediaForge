# P0606 — Music, podcasts and general audio media support: api
...
1. Inspect the existing implementation specifically for **Music, podcasts and general audio media support** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0606**
