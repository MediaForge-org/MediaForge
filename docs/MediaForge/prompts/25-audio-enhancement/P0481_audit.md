# P0481 — Audio restoration, upscaler and reconstructed editions: audit

**Track:** 25-audio-enhancement  
**Priority:** P2  
**Prompt position in track:** 1/20  
**Depends on:** P0480, P0240, P0580
...
1. Inspect the existing implementation specifically for **Audio restoration, upscaler and reconstructed editions** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0481**
