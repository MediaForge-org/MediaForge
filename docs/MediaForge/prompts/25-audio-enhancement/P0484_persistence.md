# P0484 — Audio restoration, upscaler and reconstructed editions: persistence

**Track:** 25-audio-enhancement  
**Priority:** P2  
**Prompt position in track:** 4/20  
**Depends on:** P0483, P0240, P0580
...
1. Inspect the existing implementation specifically for **Audio restoration, upscaler and reconstructed editions** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0484**
