# P0495 — Audio restoration, upscaler and reconstructed editions: unit-tests

**Track:** 25-audio-enhancement  
**Priority:** P2  
**Prompt position in track:** 15/20  
**Depends on:** P0494, P0240, P0580
...
1. Inspect the existing implementation specifically for **Audio restoration, upscaler and reconstructed editions** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0495**
