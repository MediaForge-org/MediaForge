# P0491 — Audio restoration, upscaler and reconstructed editions: realtime

**Track:** 25-audio-enhancement  
**Priority:** P2  
**Prompt position in track:** 11/20  
**Depends on:** P0490, P0240, P0580
...
1. Inspect the existing implementation specifically for **Audio restoration, upscaler and reconstructed editions** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0491**
