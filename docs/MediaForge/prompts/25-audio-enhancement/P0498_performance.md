# P0498 — Audio restoration, upscaler and reconstructed editions: performance

**Track:** 25-audio-enhancement  
**Priority:** P2  
**Prompt position in track:** 18/20  
**Depends on:** P0497, P0240, P0580
...
1. Inspect the existing implementation specifically for **Audio restoration, upscaler and reconstructed editions** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0498**
