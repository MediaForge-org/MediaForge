# P0490 — Audio restoration, upscaler and reconstructed editions: jobs

**Track:** 25-audio-enhancement  
**Priority:** P2  
**Prompt position in track:** 10/20  
**Depends on:** P0489, P0240, P0580
...
1. Inspect the existing implementation specifically for **Audio restoration, upscaler and reconstructed editions** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0490**
