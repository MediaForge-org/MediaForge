# P0497 — Audio restoration, upscaler and reconstructed editions: e2e-tests

**Track:** 25-audio-enhancement  
**Priority:** P2  
**Prompt position in track:** 17/20  
**Depends on:** P0496, P0240, P0580
...
1. Inspect the existing implementation specifically for **Audio restoration, upscaler and reconstructed editions** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0497**
