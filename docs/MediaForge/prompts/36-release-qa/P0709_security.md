# P0709 — Docker images, CI, releases, security QA and final integration: security
...
1. Inspect the existing implementation specifically for **Docker images, CI, releases, security QA and final integration** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0709**
