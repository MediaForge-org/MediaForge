# P0706 — Docker images, CI, releases, security QA and final integration: api
...
1. Inspect the existing implementation specifically for **Docker images, CI, releases, security QA and final integration** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0706**
