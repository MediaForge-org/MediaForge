# P0716 — Docker images, CI, releases, security QA and final integration: integration-tests
...
1. Inspect the existing implementation specifically for **Docker images, CI, releases, security QA and final integration** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0716**
