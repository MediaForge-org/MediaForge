# P0705 — Docker images, CI, releases, security QA and final integration: application
...
1. Inspect the existing implementation specifically for **Docker images, CI, releases, security QA and final integration** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0705**
