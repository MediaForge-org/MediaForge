# P0707 — Docker images, CI, releases, security QA and final integration: frontend
...
1. Inspect the existing implementation specifically for **Docker images, CI, releases, security QA and final integration** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0707**
