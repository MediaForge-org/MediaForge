# P0718 — Docker images, CI, releases, security QA and final integration: performance
...
1. Inspect the existing implementation specifically for **Docker images, CI, releases, security QA and final integration** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0718**
