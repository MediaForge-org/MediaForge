# P0282 — SABnzbd/qBittorrent intake, staging and import sandbox: model

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 2/20  
**Depends on:** P0281, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0282**
