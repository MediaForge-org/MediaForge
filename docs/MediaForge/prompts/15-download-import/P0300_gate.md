# P0300 — SABnzbd/qBittorrent intake, staging and import sandbox: gate

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 20/20  
**Depends on:** P0299, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **gate**.
...
- **Tests run + results**
- **Behavior guaranteed after P0300**
