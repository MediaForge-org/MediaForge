# P0285 — SABnzbd/qBittorrent intake, staging and import sandbox: application

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 5/20  
**Depends on:** P0284, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0285**
