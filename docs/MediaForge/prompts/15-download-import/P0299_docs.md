# P0299 — SABnzbd/qBittorrent intake, staging and import sandbox: docs

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 19/20  
**Depends on:** P0298, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **docs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0299**
