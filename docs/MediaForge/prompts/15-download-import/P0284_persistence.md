# P0284 — SABnzbd/qBittorrent intake, staging and import sandbox: persistence

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 4/20  
**Depends on:** P0283, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0284**
