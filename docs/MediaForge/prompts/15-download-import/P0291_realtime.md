# P0291 — SABnzbd/qBittorrent intake, staging and import sandbox: realtime

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 11/20  
**Depends on:** P0290, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0291**
