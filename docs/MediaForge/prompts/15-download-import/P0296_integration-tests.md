# P0296 — SABnzbd/qBittorrent intake, staging and import sandbox: integration-tests

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 16/20  
**Depends on:** P0295, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0296**
