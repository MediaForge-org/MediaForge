# P0286 — SABnzbd/qBittorrent intake, staging and import sandbox: api

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 6/20  
**Depends on:** P0285, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0286**
