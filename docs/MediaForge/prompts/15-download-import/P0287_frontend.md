# P0287 — SABnzbd/qBittorrent intake, staging and import sandbox: frontend

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 7/20  
**Depends on:** P0286, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0287**
