# P0293 — SABnzbd/qBittorrent intake, staging and import sandbox: migration

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 13/20  
**Depends on:** P0292, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **migration**.
...
- **Tests run + results**
- **Behavior guaranteed after P0293**
