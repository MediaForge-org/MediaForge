# P0283 — SABnzbd/qBittorrent intake, staging and import sandbox: boundaries

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 3/20  
**Depends on:** P0282, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0283**
