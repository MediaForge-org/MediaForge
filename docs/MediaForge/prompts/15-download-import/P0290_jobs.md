# P0290 — SABnzbd/qBittorrent intake, staging and import sandbox: jobs

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 10/20  
**Depends on:** P0289, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0290**
