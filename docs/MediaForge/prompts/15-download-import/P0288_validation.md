# P0288 — SABnzbd/qBittorrent intake, staging and import sandbox: validation

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 8/20  
**Depends on:** P0287, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0288**
