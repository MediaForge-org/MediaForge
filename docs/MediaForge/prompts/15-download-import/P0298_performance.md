# P0298 — SABnzbd/qBittorrent intake, staging and import sandbox: performance

**Track:** 15-download-import  
**Priority:** P1  
**Prompt position in track:** 18/20  
**Depends on:** P0297, P0280
...
1. Inspect the existing implementation specifically for **SABnzbd/qBittorrent intake, staging and import sandbox** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0298**
