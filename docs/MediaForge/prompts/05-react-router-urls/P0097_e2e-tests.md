# P0097 — React Router, human-readable routing and removal of Inertia: e2e-tests
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0097**
