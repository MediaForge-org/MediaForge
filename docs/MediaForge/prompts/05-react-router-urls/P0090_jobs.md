# P0090 — React Router, human-readable routing and removal of Inertia: jobs
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0090**
