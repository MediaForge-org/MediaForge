# P0088 — React Router, human-readable routing and removal of Inertia: validation
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0088**
