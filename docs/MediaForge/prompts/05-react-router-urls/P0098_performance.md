# P0098 — React Router, human-readable routing and removal of Inertia: performance
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0098**
