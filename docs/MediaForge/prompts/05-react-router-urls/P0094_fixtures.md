# P0094 — React Router, human-readable routing and removal of Inertia: fixtures
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0094**
