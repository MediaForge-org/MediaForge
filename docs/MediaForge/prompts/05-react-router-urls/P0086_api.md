# P0086 — React Router, human-readable routing and removal of Inertia: api
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0086**
