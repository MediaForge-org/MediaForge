# P0089 — React Router, human-readable routing and removal of Inertia: security
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0089**
