# P0096 — React Router, human-readable routing and removal of Inertia: integration-tests
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0096**
