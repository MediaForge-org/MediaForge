# P0095 — React Router, human-readable routing and removal of Inertia: unit-tests
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0095**
