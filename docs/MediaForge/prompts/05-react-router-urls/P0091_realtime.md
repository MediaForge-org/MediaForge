# P0091 — React Router, human-readable routing and removal of Inertia: realtime
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0091**
