# P0087 — React Router, human-readable routing and removal of Inertia: frontend
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0087**
