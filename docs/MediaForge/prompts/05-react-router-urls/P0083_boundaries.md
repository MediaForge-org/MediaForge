# P0083 — React Router, human-readable routing and removal of Inertia: boundaries
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0083**
