# P0081 — React Router, human-readable routing and removal of Inertia: audit
...
1. Inspect the existing implementation specifically for **React Router, human-readable routing and removal of Inertia** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0081**
