# P0370 — Audiobook works, editions, chapters and storage choices: jobs
...
1. Inspect the existing implementation specifically for **Audiobook works, editions, chapters and storage choices** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0370**
