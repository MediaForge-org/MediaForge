# P0368 — Audiobook works, editions, chapters and storage choices: validation
...
1. Inspect the existing implementation specifically for **Audiobook works, editions, chapters and storage choices** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0368**
