# P0367 — Audiobook works, editions, chapters and storage choices: frontend
...
- Expose audiobook-appropriate audio presets/controls through the shared player UI, including voice clarity and loudness behavior, while preserving chapter/progress semantics and avoiding a separate incompatible audio model.
...
1. Inspect the existing implementation specifically for **Audiobook works, editions, chapters and storage choices** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0367**
