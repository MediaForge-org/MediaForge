# P0366 — Audiobook works, editions, chapters and storage choices: api
...
1. Inspect the existing implementation specifically for **Audiobook works, editions, chapters and storage choices** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0366**
