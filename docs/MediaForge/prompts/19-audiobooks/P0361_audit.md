# P0361 — Audiobook works, editions, chapters and storage choices: audit
...
1. Inspect the existing implementation specifically for **Audiobook works, editions, chapters and storage choices** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0361**
