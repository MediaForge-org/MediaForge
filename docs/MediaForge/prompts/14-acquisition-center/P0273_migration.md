# P0273 — Acquisition Center domain and source abstraction: migration
...
1. Inspect the existing implementation specifically for **Acquisition Center domain and source abstraction** and the current focus **migration**.
...
- **Tests run + results**
- **Behavior guaranteed after P0273**
