# P0266 — Acquisition Center domain and source abstraction: api
...
1. Inspect the existing implementation specifically for **Acquisition Center domain and source abstraction** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0266**
