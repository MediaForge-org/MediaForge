# P0276 — Acquisition Center domain and source abstraction: integration-tests
...
1. Inspect the existing implementation specifically for **Acquisition Center domain and source abstraction** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0276**
