# P0275 — Acquisition Center domain and source abstraction: unit-tests
...
1. Inspect the existing implementation specifically for **Acquisition Center domain and source abstraction** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0275**
