# P0270 — Acquisition Center domain and source abstraction: jobs
...
1. Inspect the existing implementation specifically for **Acquisition Center domain and source abstraction** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0270**
