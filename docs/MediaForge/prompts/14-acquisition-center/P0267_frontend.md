# P0267 — Acquisition Center domain and source abstraction: frontend
...
1. Inspect the existing implementation specifically for **Acquisition Center domain and source abstraction** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0267**
