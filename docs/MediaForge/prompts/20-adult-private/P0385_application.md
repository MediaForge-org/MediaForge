# P0385 — Adult private-mode foundation and zero-leak UX: application
...
1. Inspect the existing implementation specifically for **Adult private-mode foundation and zero-leak UX** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0385**
