# P0391 — Adult private-mode foundation and zero-leak UX: realtime
...
1. Inspect the existing implementation specifically for **Adult private-mode foundation and zero-leak UX** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0391**
