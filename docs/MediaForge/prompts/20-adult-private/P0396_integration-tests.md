# P0396 — Adult private-mode foundation and zero-leak UX: integration-tests
...
1. Inspect the existing implementation specifically for **Adult private-mode foundation and zero-leak UX** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0396**
