# P0390 — Adult private-mode foundation and zero-leak UX: jobs
...
1. Inspect the existing implementation specifically for **Adult private-mode foundation and zero-leak UX** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0390**
