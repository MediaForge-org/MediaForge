# P0387 — Adult private-mode foundation and zero-leak UX: frontend
...
1. Inspect the existing implementation specifically for **Adult private-mode foundation and zero-leak UX** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0387**
