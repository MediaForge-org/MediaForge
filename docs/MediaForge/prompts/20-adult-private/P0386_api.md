# P0386 — Adult private-mode foundation and zero-leak UX: api
...
1. Inspect the existing implementation specifically for **Adult private-mode foundation and zero-leak UX** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0386**
