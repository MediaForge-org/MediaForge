# P0399 — Adult private-mode foundation and zero-leak UX: docs
...
1. Inspect the existing implementation specifically for **Adult private-mode foundation and zero-leak UX** and the current focus **docs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0399**
