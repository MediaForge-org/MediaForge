# P0156 — PostgreSQL canonical model and database boundaries: integration-tests
...
1. Inspect the existing implementation specifically for **PostgreSQL canonical model and database boundaries** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0156**
