# P0153 — PostgreSQL canonical model and database boundaries: migration
...
1. Inspect the existing implementation specifically for **PostgreSQL canonical model and database boundaries** and the current focus **migration**.
...
- **Tests run + results**
- **Behavior guaranteed after P0153**
