# P0146 — PostgreSQL canonical model and database boundaries: api
...
1. Inspect the existing implementation specifically for **PostgreSQL canonical model and database boundaries** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0146**
