# P0147 — PostgreSQL canonical model and database boundaries: frontend
...
1. Inspect the existing implementation specifically for **PostgreSQL canonical model and database boundaries** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0147**
