# P0158 — PostgreSQL canonical model and database boundaries: performance
...
1. Inspect the existing implementation specifically for **PostgreSQL canonical model and database boundaries** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0158**
