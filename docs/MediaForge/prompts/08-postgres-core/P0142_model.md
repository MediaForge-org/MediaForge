# P0142 — PostgreSQL canonical model and database boundaries: model
...
1. Inspect the existing implementation specifically for **PostgreSQL canonical model and database boundaries** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0142**
