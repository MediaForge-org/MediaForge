# P0345 — Movies, cuts, technical editions and extras: application
...
1. Inspect the existing implementation specifically for **Movies, cuts, technical editions and extras** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0345**
