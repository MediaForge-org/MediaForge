# P0357 — Movies, cuts, technical editions and extras: e2e-tests
...
1. Inspect the existing implementation specifically for **Movies, cuts, technical editions and extras** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0357**
