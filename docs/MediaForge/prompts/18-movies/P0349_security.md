# P0349 — Movies, cuts, technical editions and extras: security
...
1. Inspect the existing implementation specifically for **Movies, cuts, technical editions and extras** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0349**
