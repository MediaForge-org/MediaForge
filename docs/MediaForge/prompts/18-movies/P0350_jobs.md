# P0350 — Movies, cuts, technical editions and extras: jobs
...
1. Inspect the existing implementation specifically for **Movies, cuts, technical editions and extras** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0350**
