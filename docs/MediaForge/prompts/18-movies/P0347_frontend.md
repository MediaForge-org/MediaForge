# P0347 — Movies, cuts, technical editions and extras: frontend
...
1. Inspect the existing implementation specifically for **Movies, cuts, technical editions and extras** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0347**
