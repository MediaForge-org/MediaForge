# P0346 — Movies, cuts, technical editions and extras: api
...
1. Inspect the existing implementation specifically for **Movies, cuts, technical editions and extras** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0346**
