# P0046 — Laravel server relocation into apps/server: api
...
1. Inspect the existing implementation specifically for **Laravel server relocation into apps/server** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0046**
