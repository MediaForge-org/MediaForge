# P0045 — Laravel server relocation into apps/server: application
...
1. Inspect the existing implementation specifically for **Laravel server relocation into apps/server** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0045**
