# P0050 — Laravel server relocation into apps/server: jobs
...
1. Inspect the existing implementation specifically for **Laravel server relocation into apps/server** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0050**
