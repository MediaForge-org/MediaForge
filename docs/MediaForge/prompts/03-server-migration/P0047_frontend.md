# P0047 — Laravel server relocation into apps/server: frontend
...
1. Inspect the existing implementation specifically for **Laravel server relocation into apps/server** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0047**
