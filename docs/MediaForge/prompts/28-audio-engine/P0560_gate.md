# P0560 — Audiobookshelf-derived audio engine integration and fork boundary: gate

**Track:** 28-audio-engine  
**Priority:** P2  
**Prompt position in track:** 20/20  
**Depends on:** P0559, P0140, P0120
...
- Gate the audio-engine bridge against MediaForge's canonical audio/profile semantics, spoken-word behavior and explicit requested-vs-effective capability reporting.
...
1. Inspect the existing implementation specifically for **Audiobookshelf-derived audio engine integration and fork boundary** and the current focus **gate**.
...
- **Tests run + results**
- **Behavior guaranteed after P0560**
