# P0027 — Target monorepo root structure and migration scaffolding: frontend
...
1. Inspect the existing implementation specifically for **Target monorepo root structure and migration scaffolding** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0027**
