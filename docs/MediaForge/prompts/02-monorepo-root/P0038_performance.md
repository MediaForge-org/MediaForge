# P0038 — Target monorepo root structure and migration scaffolding: performance
...
1. Inspect the existing implementation specifically for **Target monorepo root structure and migration scaffolding** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0038**
