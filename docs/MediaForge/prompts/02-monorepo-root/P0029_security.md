# P0029 — Target monorepo root structure and migration scaffolding: security
...
1. Inspect the existing implementation specifically for **Target monorepo root structure and migration scaffolding** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0029**
