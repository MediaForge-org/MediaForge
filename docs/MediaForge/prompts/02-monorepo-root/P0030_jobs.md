# P0030 — Target monorepo root structure and migration scaffolding: jobs
...
1. Inspect the existing implementation specifically for **Target monorepo root structure and migration scaffolding** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0030**
