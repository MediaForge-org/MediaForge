# P0117 — MediaForge API v1 and BFF boundary: e2e-tests
...
1. Inspect the existing implementation specifically for **MediaForge API v1 and BFF boundary** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0117**
