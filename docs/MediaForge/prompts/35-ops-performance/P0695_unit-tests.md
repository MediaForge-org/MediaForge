# P0695 — Observability, performance, backup, restore and resilience: unit-tests
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0695**
