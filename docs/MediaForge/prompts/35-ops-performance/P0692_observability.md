# P0692 — Observability, performance, backup, restore and resilience: observability
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **observability**.
...
- **Tests run + results**
- **Behavior guaranteed after P0692**
