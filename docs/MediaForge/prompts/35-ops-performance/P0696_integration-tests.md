# P0696 — Observability, performance, backup, restore and resilience: integration-tests
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0696**
