# P0681 — Observability, performance, backup, restore and resilience: audit
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0681**
