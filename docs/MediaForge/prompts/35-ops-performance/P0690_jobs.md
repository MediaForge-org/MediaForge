# P0690 — Observability, performance, backup, restore and resilience: jobs
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0690**
