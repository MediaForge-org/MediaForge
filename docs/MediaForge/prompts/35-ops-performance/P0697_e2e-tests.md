# P0697 — Observability, performance, backup, restore and resilience: e2e-tests
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0697**
