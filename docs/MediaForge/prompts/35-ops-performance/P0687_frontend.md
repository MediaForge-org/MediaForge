# P0687 — Observability, performance, backup, restore and resilience: frontend
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0687**
