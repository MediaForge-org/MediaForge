# P0686 — Observability, performance, backup, restore and resilience: api
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0686**
