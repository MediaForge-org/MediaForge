# P0698 — Observability, performance, backup, restore and resilience: performance
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0698**
