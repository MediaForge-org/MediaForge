# P0685 — Observability, performance, backup, restore and resilience: application
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0685**
