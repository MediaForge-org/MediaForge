# P0699 — Observability, performance, backup, restore and resilience: docs
...
1. Inspect the existing implementation specifically for **Observability, performance, backup, restore and resilience** and the current focus **docs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0699**
