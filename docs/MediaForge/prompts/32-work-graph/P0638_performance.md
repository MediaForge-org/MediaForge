# P0638 — Work graph, collections, recommendations and cross-media relations: performance
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0638**
