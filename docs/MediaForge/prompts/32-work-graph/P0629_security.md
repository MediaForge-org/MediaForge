# P0629 — Work graph, collections, recommendations and cross-media relations: security
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0629**
