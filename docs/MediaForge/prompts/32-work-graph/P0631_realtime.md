# P0631 — Work graph, collections, recommendations and cross-media relations: realtime
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0631**
