# P0632 — Work graph, collections, recommendations and cross-media relations: observability
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **observability**.
...
- **Tests run + results**
- **Behavior guaranteed after P0632**
