# P0636 — Work graph, collections, recommendations and cross-media relations: integration-tests
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0636**
