# P0630 — Work graph, collections, recommendations and cross-media relations: jobs
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0630**
