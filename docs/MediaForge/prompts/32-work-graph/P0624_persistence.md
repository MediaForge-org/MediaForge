# P0624 — Work graph, collections, recommendations and cross-media relations: persistence
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0624**
