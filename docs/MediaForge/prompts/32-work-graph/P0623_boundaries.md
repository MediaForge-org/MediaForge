# P0623 — Work graph, collections, recommendations and cross-media relations: boundaries
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0623**
