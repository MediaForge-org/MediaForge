# P0627 — Work graph, collections, recommendations and cross-media relations: frontend
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0627**
