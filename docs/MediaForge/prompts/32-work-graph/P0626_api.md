# P0626 — Work graph, collections, recommendations and cross-media relations: api
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0626**
