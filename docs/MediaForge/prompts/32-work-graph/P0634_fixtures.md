# P0634 — Work graph, collections, recommendations and cross-media relations: fixtures
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0634**
