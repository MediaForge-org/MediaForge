# P0628 — Work graph, collections, recommendations and cross-media relations: validation
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0628**
