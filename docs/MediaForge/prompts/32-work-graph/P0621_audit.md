# P0621 — Work graph, collections, recommendations and cross-media relations: audit
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0621**
