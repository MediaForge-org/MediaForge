# P0639 — Work graph, collections, recommendations and cross-media relations: docs
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **docs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0639**
