# P0622 — Work graph, collections, recommendations and cross-media relations: model
...
1. Inspect the existing implementation specifically for **Work graph, collections, recommendations and cross-media relations** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0622**
