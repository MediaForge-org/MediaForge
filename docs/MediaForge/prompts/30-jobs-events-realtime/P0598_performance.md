# P0598 — Background jobs, events, realtime progress and orchestration: performance
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0598**
