# P0600 — Background jobs, events, realtime progress and orchestration: gate
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **gate**.
...
- **Tests run + results**
- **Behavior guaranteed after P0600**
