# P0581 — Background jobs, events, realtime progress and orchestration: audit
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0581**
