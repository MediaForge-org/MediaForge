# P0585 — Background jobs, events, realtime progress and orchestration: application
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0585**
