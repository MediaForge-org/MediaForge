# P0590 — Background jobs, events, realtime progress and orchestration: jobs
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0590**
