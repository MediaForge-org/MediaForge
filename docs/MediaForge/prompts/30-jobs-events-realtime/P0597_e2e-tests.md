# P0597 — Background jobs, events, realtime progress and orchestration: e2e-tests
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0597**
