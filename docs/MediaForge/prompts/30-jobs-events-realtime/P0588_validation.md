# P0588 — Background jobs, events, realtime progress and orchestration: validation
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0588**
