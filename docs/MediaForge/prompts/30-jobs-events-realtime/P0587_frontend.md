# P0587 — Background jobs, events, realtime progress and orchestration: frontend
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0587**
