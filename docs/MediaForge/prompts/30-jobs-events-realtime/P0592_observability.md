# P0592 — Background jobs, events, realtime progress and orchestration: observability
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **observability**.
...
- **Tests run + results**
- **Behavior guaranteed after P0592**
