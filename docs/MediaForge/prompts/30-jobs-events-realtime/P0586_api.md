# P0586 — Background jobs, events, realtime progress and orchestration: api
...
1. Inspect the existing implementation specifically for **Background jobs, events, realtime progress and orchestration** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0586**
