# P0463 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: boundaries

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 3/20  
**Depends on:** P0462, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0463**
