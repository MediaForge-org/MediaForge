# P0461 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: audit

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 1/20  
**Depends on:** P0460, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0461**
