# P0470 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: jobs

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 10/20  
**Depends on:** P0469, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0470**
