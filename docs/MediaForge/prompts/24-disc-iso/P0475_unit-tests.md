# P0475 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: unit-tests

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 15/20  
**Depends on:** P0474, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0475**
