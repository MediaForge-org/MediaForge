# P0478 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: performance

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 18/20  
**Depends on:** P0477, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0478**
