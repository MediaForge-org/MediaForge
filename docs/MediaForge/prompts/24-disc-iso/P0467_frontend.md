# P0467 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: frontend

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 7/20  
**Depends on:** P0466, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0467**
