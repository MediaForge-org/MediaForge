# P0465 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: application

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 5/20  
**Depends on:** P0464, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0465**
