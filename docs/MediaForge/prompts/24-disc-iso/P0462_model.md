# P0462 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: model

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 2/20  
**Depends on:** P0461, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0462**
