# P0473 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: migration

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 13/20  
**Depends on:** P0472, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **migration**.
...
- **Tests run + results**
- **Behavior guaranteed after P0473**
