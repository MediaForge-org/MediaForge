# P0476 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: integration-tests

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 16/20  
**Depends on:** P0475, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0476**
