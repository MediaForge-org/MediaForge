# P0477 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: e2e-tests

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 17/20  
**Depends on:** P0476, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0477**
