# P0471 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: realtime

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 11/20  
**Depends on:** P0470, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0471**
