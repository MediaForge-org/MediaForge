# P0469 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: security

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 9/20  
**Depends on:** P0468, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0469**
