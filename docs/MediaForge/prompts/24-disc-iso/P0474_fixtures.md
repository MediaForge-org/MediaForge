# P0474 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: fixtures

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 14/20  
**Depends on:** P0473, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0474**
