# P0480 — Disc, ISO, BDMV, VIDEO_TS and verified-only mapping: gate

**Track:** 24-disc-iso  
**Priority:** P2  
**Prompt position in track:** 20/20  
**Depends on:** P0479, P0240, P0580
...
1. Inspect the existing implementation specifically for **Disc, ISO, BDMV, VIDEO_TS and verified-only mapping** and the current focus **gate**.
...
- **Tests run + results**
- **Behavior guaranteed after P0480**
