# P0190 — MediaForge design system and UI primitives: jobs
...
1. Inspect the existing implementation specifically for **MediaForge design system and UI primitives** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0190**
