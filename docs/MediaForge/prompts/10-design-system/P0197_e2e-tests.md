# P0197 — MediaForge design system and UI primitives: e2e-tests
...
1. Inspect the existing implementation specifically for **MediaForge design system and UI primitives** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0197**
