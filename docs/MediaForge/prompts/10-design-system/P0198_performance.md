# P0198 — MediaForge design system and UI primitives: performance
...
1. Inspect the existing implementation specifically for **MediaForge design system and UI primitives** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0198**
