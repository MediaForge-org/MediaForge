# P0061 — React/TypeScript web app relocation into apps/web: audit
...
1. Inspect the existing implementation specifically for **React/TypeScript web app relocation into apps/web** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0061**
