# P0073 — React/TypeScript web app relocation into apps/web: migration
...
1. Inspect the existing implementation specifically for **React/TypeScript web app relocation into apps/web** and the current focus **migration**.
...
- **Tests run + results**
- **Behavior guaranteed after P0073**
