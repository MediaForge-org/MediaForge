# P0067 — React/TypeScript web app relocation into apps/web: frontend
...
1. Inspect the existing implementation specifically for **React/TypeScript web app relocation into apps/web** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0067**
