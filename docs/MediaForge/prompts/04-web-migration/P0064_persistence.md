# P0064 — React/TypeScript web app relocation into apps/web: persistence
...
1. Inspect the existing implementation specifically for **React/TypeScript web app relocation into apps/web** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0064**
