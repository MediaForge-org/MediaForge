# P0070 — React/TypeScript web app relocation into apps/web: jobs
...
1. Inspect the existing implementation specifically for **React/TypeScript web app relocation into apps/web** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0070**
