# P0065 — React/TypeScript web app relocation into apps/web: application
...
1. Inspect the existing implementation specifically for **React/TypeScript web app relocation into apps/web** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0065**
