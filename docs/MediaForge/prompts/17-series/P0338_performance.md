# P0338 — Series, seasons, episodes, orders and timeline features: performance
...
1. Inspect the existing implementation specifically for **Series, seasons, episodes, orders and timeline features** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0338**
