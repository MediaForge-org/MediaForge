# P0332 — Series, seasons, episodes, orders and timeline features: observability
...
1. Inspect the existing implementation specifically for **Series, seasons, episodes, orders and timeline features** and the current focus **observability**.
...
- **Tests run + results**
- **Behavior guaranteed after P0332**
