# P0322 — Series, seasons, episodes, orders and timeline features: model
...
1. Inspect the existing implementation specifically for **Series, seasons, episodes, orders and timeline features** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0322**
