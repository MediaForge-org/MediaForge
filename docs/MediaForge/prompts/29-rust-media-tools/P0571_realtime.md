# P0571 — Rust MediaTools service and native media plumbing: realtime
...
1. Inspect the existing implementation specifically for **Rust MediaTools service and native media plumbing** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0571**
