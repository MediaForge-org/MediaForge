# P0570 — Rust MediaTools service and native media plumbing: jobs
...
1. Inspect the existing implementation specifically for **Rust MediaTools service and native media plumbing** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0570**
