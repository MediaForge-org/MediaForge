# P0572 — Rust MediaTools service and native media plumbing: observability
...
1. Inspect the existing implementation specifically for **Rust MediaTools service and native media plumbing** and the current focus **observability**.
...
- **Tests run + results**
- **Behavior guaranteed after P0572**
