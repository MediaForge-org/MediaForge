...
- Gate any native audio helpers for deterministic output, analysis provenance/versioning and conformance to the canonical player-audio contracts without transferring domain ownership into Rust.
