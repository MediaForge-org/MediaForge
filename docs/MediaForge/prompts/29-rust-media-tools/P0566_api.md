# P0566 — Rust MediaTools service and native media plumbing: api
...
1. Inspect the existing implementation specifically for **Rust MediaTools service and native media plumbing** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0566**
