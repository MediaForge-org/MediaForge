# P0561 — Rust MediaTools service and native media plumbing: audit
...
1. Inspect the existing implementation specifically for **Rust MediaTools service and native media plumbing** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0561**
