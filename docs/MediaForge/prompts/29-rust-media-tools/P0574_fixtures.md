# P0574 — Rust MediaTools service and native media plumbing: fixtures
...
1. Inspect the existing implementation specifically for **Rust MediaTools service and native media plumbing** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0574**
