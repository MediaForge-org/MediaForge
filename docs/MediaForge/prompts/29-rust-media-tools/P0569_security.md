# P0569 — Rust MediaTools service and native media plumbing: security
...
1. Inspect the existing implementation specifically for **Rust MediaTools service and native media plumbing** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0569**
