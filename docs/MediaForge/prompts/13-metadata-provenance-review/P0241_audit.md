# P0241 — Metadata vault, provenance, matching and review center: audit
...
1. Inspect the existing implementation specifically for **Metadata vault, provenance, matching and review center** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0241**
