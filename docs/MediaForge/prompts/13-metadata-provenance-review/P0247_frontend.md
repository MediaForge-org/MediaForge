# P0247 — Metadata vault, provenance, matching and review center: frontend
...
1. Inspect the existing implementation specifically for **Metadata vault, provenance, matching and review center** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0247**
