# P0246 — Metadata vault, provenance, matching and review center: api
...
1. Inspect the existing implementation specifically for **Metadata vault, provenance, matching and review center** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0246**
