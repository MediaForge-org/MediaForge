# P0250 — Metadata vault, provenance, matching and review center: jobs
...
1. Inspect the existing implementation specifically for **Metadata vault, provenance, matching and review center** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0250**
