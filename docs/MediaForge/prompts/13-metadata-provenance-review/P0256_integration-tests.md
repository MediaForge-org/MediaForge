# P0256 — Metadata vault, provenance, matching and review center: integration-tests
...
1. Inspect the existing implementation specifically for **Metadata vault, provenance, matching and review center** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0256**
