# P0245 — Metadata vault, provenance, matching and review center: application
...
1. Inspect the existing implementation specifically for **Metadata vault, provenance, matching and review center** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0245**
