# P0254 — Metadata vault, provenance, matching and review center: fixtures
...
1. Inspect the existing implementation specifically for **Metadata vault, provenance, matching and review center** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0254**
