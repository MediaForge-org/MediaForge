# P0647 — Desktop, mobile and TV clients plus shared SDKs: frontend
...
1. Inspect the existing implementation specifically for **Desktop, mobile and TV clients plus shared SDKs** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0647**
