# P0658 — Desktop, mobile and TV clients plus shared SDKs: performance
...
1. Inspect the existing implementation specifically for **Desktop, mobile and TV clients plus shared SDKs** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0658**
