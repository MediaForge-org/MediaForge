# P0655 — Desktop, mobile and TV clients plus shared SDKs: unit-tests
...
1. Inspect the existing implementation specifically for **Desktop, mobile and TV clients plus shared SDKs** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0655**
