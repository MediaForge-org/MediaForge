# P0648 — Desktop, mobile and TV clients plus shared SDKs: validation
...
1. Inspect the existing implementation specifically for **Desktop, mobile and TV clients plus shared SDKs** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0648**
