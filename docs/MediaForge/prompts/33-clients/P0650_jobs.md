# P0650 — Desktop, mobile and TV clients plus shared SDKs: jobs
...
1. Inspect the existing implementation specifically for **Desktop, mobile and TV clients plus shared SDKs** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0650**
