# P0130 — OpenAPI, JSON Schema, events and generated clients: jobs
...
1. Inspect the existing implementation specifically for **OpenAPI, JSON Schema, events and generated clients** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0130**
