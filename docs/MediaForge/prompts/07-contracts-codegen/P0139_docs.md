# P0139 — OpenAPI, JSON Schema, events and generated clients: docs
...
1. Inspect the existing implementation specifically for **OpenAPI, JSON Schema, events and generated clients** and the current focus **docs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0139**
