# P0137 — OpenAPI, JSON Schema, events and generated clients: e2e-tests
...
1. Inspect the existing implementation specifically for **OpenAPI, JSON Schema, events and generated clients** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0137**
