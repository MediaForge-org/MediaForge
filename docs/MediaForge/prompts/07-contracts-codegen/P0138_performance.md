# P0138 — OpenAPI, JSON Schema, events and generated clients: performance
...
1. Inspect the existing implementation specifically for **OpenAPI, JSON Schema, events and generated clients** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0138**
