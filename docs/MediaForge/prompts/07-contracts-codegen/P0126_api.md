# P0126 — OpenAPI, JSON Schema, events and generated clients: api
...
1. Inspect the existing implementation specifically for **OpenAPI, JSON Schema, events and generated clients** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0126**
