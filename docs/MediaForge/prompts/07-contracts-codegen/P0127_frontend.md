# P0127 — OpenAPI, JSON Schema, events and generated clients: frontend
...
1. Inspect the existing implementation specifically for **OpenAPI, JSON Schema, events and generated clients** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0127**
