# P0221 — Library, files, editions and storage model: audit
...
1. Inspect the existing implementation specifically for **Library, files, editions and storage model** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0221**
