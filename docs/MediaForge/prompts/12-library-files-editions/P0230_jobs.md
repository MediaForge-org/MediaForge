# P0230 — Library, files, editions and storage model: jobs
...
1. Inspect the existing implementation specifically for **Library, files, editions and storage model** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0230**
