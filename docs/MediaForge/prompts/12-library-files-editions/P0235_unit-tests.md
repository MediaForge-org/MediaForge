# P0235 — Library, files, editions and storage model: unit-tests
...
1. Inspect the existing implementation specifically for **Library, files, editions and storage model** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0235**
