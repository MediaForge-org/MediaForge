# P0229 — Library, files, editions and storage model: security
...
1. Inspect the existing implementation specifically for **Library, files, editions and storage model** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0229**
