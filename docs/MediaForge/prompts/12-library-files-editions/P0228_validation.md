# P0228 — Library, files, editions and storage model: validation
...
1. Inspect the existing implementation specifically for **Library, files, editions and storage model** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0228**
