# P0227 — Library, files, editions and storage model: frontend
...
1. Inspect the existing implementation specifically for **Library, files, editions and storage model** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0227**
