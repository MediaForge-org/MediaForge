# P0446 — Full video/audio analysis, timestamps and multimodal detection: api

**Track:** 23-adult-analysis  
**Priority:** P2  
**Prompt position in track:** 6/20  
**Depends on:** P0445, P0440, P0580
...
1. Inspect the existing implementation specifically for **Full video/audio analysis, timestamps and multimodal detection** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0446**
