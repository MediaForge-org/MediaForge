# P0444 — Full video/audio analysis, timestamps and multimodal detection: persistence

**Track:** 23-adult-analysis  
**Priority:** P2  
**Prompt position in track:** 4/20  
**Depends on:** P0443, P0440, P0580
...
1. Inspect the existing implementation specifically for **Full video/audio analysis, timestamps and multimodal detection** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0444**
