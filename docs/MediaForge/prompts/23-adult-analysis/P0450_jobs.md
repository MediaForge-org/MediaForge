# P0450 — Full video/audio analysis, timestamps and multimodal detection: jobs

**Track:** 23-adult-analysis  
**Priority:** P2  
**Prompt position in track:** 10/20  
**Depends on:** P0449, P0440, P0580
...
1. Inspect the existing implementation specifically for **Full video/audio analysis, timestamps and multimodal detection** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0450**
