# P0310 — Unified playback sessions, gateway and stream routing: jobs
...
1. Inspect the existing implementation specifically for **Unified playback sessions, gateway and stream routing** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0310**
