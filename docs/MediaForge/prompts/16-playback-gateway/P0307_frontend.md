# P0307 — Unified playback sessions, gateway and stream routing: frontend
...
1. Inspect the existing implementation specifically for **Unified playback sessions, gateway and stream routing** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0307**
