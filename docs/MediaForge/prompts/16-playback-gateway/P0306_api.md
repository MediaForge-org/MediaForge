# P0306 — Unified playback sessions, gateway and stream routing: api
...
- Expose canonical MediaForge audio contracts capable of representing volume_percent, max_volume_percent (100|150|200), preamp_db, normalization/target_lufs, limiter/ceiling, dialogue/voice boost, DRC, EQ, downmix, profile scope/inheritance, requested state and effective/degraded capability state.
- Keep the API engine-neutral and do not leak Jellyfin/Audiobookshelf implementation identifiers.

## Exact work for this prompt

1. Inspect the existing implementation specifically for **Unified playback sessions, gateway and stream routing** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0306**
