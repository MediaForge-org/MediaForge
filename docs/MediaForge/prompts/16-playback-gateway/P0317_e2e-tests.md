# P0317 — Unified playback sessions, gateway and stream routing: e2e-tests
...
- Exercise the simple 0–200% volume experience and advanced audio controls end-to-end, including accessibility, boost-zone feedback, unsupported/degraded state, persistence/inheritance where applicable and TV/remote-oriented focus behavior.

## Exact work for this prompt

1. Inspect the existing implementation specifically for **Unified playback sessions, gateway and stream routing** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0317**
