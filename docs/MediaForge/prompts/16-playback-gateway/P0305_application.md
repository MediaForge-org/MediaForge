# P0305 — Unified playback sessions, gateway and stream routing: application
...
1. Inspect the existing implementation specifically for **Unified playback sessions, gateway and stream routing** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0305**
