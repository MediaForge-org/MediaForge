# P0662 — Plugin SDK, metadata providers and automation extensions: model
...
1. Inspect the existing implementation specifically for **Plugin SDK, metadata providers and automation extensions** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0662**
