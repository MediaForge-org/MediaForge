# P0663 — Plugin SDK, metadata providers and automation extensions: boundaries
...
1. Inspect the existing implementation specifically for **Plugin SDK, metadata providers and automation extensions** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0663**
