# P0670 — Plugin SDK, metadata providers and automation extensions: jobs
...
1. Inspect the existing implementation specifically for **Plugin SDK, metadata providers and automation extensions** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0670**
