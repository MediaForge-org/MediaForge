# P0661 — Plugin SDK, metadata providers and automation extensions: audit
...
1. Inspect the existing implementation specifically for **Plugin SDK, metadata providers and automation extensions** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0661**
