# P0667 — Plugin SDK, metadata providers and automation extensions: frontend
...
1. Inspect the existing implementation specifically for **Plugin SDK, metadata providers and automation extensions** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0667**
