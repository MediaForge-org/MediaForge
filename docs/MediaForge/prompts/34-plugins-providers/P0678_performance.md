# P0678 — Plugin SDK, metadata providers and automation extensions: performance
...
1. Inspect the existing implementation specifically for **Plugin SDK, metadata providers and automation extensions** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0678**
