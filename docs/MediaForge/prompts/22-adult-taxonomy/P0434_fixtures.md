# P0434 — Hierarchical adult tags, attributes, evidence and event model: fixtures

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 14/20  
**Depends on:** P0433, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0434**
