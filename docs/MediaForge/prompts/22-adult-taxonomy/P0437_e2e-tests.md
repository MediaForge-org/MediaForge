# P0437 — Hierarchical adult tags, attributes, evidence and event model: e2e-tests

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 17/20  
**Depends on:** P0436, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **e2e-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0437**
