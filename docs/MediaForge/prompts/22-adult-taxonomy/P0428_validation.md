# P0428 — Hierarchical adult tags, attributes, evidence and event model: validation

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 8/20  
**Depends on:** P0427, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **validation**.
...
- **Tests run + results**
- **Behavior guaranteed after P0428**
