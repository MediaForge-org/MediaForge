# P0423 — Hierarchical adult tags, attributes, evidence and event model: boundaries

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 3/20  
**Depends on:** P0422, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0423**
