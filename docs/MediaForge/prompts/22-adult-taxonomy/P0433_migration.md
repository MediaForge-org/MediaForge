# P0433 — Hierarchical adult tags, attributes, evidence and event model: migration

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 13/20  
**Depends on:** P0432, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **migration**.
...
- **Tests run + results**
- **Behavior guaranteed after P0433**
