# P0427 — Hierarchical adult tags, attributes, evidence and event model: frontend

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 7/20  
**Depends on:** P0426, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0427**
