# P0436 — Hierarchical adult tags, attributes, evidence and event model: integration-tests

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 16/20  
**Depends on:** P0435, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **integration-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0436**
