# P0440 — Hierarchical adult tags, attributes, evidence and event model: gate

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 20/20  
**Depends on:** P0439, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **gate**.
...
- **Tests run + results**
- **Behavior guaranteed after P0440**
