# P0431 — Hierarchical adult tags, attributes, evidence and event model: realtime

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 11/20  
**Depends on:** P0430, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **realtime**.
...
- **Tests run + results**
- **Behavior guaranteed after P0431**
