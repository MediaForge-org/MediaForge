# P0438 — Hierarchical adult tags, attributes, evidence and event model: performance

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 18/20  
**Depends on:** P0437, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **performance**.
...
- **Tests run + results**
- **Behavior guaranteed after P0438**
