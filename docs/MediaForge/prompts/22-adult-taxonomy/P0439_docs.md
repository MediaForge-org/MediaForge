# P0439 — Hierarchical adult tags, attributes, evidence and event model: docs

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 19/20  
**Depends on:** P0438, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **docs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0439**
