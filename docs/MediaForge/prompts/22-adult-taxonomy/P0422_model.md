# P0422 — Hierarchical adult tags, attributes, evidence and event model: model

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 2/20  
**Depends on:** P0421, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **model**.
...
- **Tests run + results**
- **Behavior guaranteed after P0422**
