# P0429 — Hierarchical adult tags, attributes, evidence and event model: security

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 9/20  
**Depends on:** P0428, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **security**.
...
- **Tests run + results**
- **Behavior guaranteed after P0429**
