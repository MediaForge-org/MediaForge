# P0432 — Hierarchical adult tags, attributes, evidence and event model: observability

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 12/20  
**Depends on:** P0431, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **observability**.
...
- **Tests run + results**
- **Behavior guaranteed after P0432**
