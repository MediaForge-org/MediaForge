# P0424 — Hierarchical adult tags, attributes, evidence and event model: persistence

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 4/20  
**Depends on:** P0423, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **persistence**.
...
- **Tests run + results**
- **Behavior guaranteed after P0424**
