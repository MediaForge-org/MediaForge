# P0435 — Hierarchical adult tags, attributes, evidence and event model: unit-tests

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 15/20  
**Depends on:** P0434, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **unit-tests**.
...
- **Tests run + results**
- **Behavior guaranteed after P0435**
