# P0425 — Hierarchical adult tags, attributes, evidence and event model: application

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 5/20  
**Depends on:** P0424, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **application**.
...
- **Tests run + results**
- **Behavior guaranteed after P0425**
