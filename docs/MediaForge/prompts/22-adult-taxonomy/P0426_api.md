# P0426 — Hierarchical adult tags, attributes, evidence and event model: api

**Track:** 22-adult-taxonomy  
**Priority:** P0  
**Prompt position in track:** 6/20  
**Depends on:** P0425, P0160, P0400
...
1. Inspect the existing implementation specifically for **Hierarchical adult tags, attributes, evidence and event model** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0426**
