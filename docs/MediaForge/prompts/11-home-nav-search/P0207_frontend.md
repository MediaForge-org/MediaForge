# P0207 — Unified home, navigation and global search shell: frontend
...
1. Inspect the existing implementation specifically for **Unified home, navigation and global search shell** and the current focus **frontend**.
...
- **Tests run + results**
- **Behavior guaranteed after P0207**
