# P0201 — Unified home, navigation and global search shell: audit
...
1. Inspect the existing implementation specifically for **Unified home, navigation and global search shell** and the current focus **audit**.
...
- **Tests run + results**
- **Behavior guaranteed after P0201**
