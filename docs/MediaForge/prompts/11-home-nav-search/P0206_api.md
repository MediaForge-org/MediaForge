# P0206 — Unified home, navigation and global search shell: api
...
1. Inspect the existing implementation specifically for **Unified home, navigation and global search shell** and the current focus **api**.
...
- **Tests run + results**
- **Behavior guaranteed after P0206**
