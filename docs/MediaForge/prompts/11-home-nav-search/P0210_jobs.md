# P0210 — Unified home, navigation and global search shell: jobs
...
1. Inspect the existing implementation specifically for **Unified home, navigation and global search shell** and the current focus **jobs**.
...
- **Tests run + results**
- **Behavior guaranteed after P0210**
