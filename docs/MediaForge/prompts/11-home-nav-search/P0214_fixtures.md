# P0214 — Unified home, navigation and global search shell: fixtures
...
1. Inspect the existing implementation specifically for **Unified home, navigation and global search shell** and the current focus **fixtures**.
...
- **Tests run + results**
- **Behavior guaranteed after P0214**
