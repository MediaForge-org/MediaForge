# P0203 — Unified home, navigation and global search shell: boundaries
...
1. Inspect the existing implementation specifically for **Unified home, navigation and global search shell** and the current focus **boundaries**.
...
- **Tests run + results**
- **Behavior guaranteed after P0203**
